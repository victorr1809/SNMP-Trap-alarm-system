...
public class Handler implements Runnable {
	...
	private String type;
	private String insertSQL = "CALL alarm.insert_alarm_all2(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	// Hàm update alarm khi nhận END record
	// Nếu END đến trước START, procedure sẽ tự động INSERT với status='CLEARED'
	private void updateAlarmEnd(StructureAlarm alarm) {
		try {
			...
			updateStmt.setString(21, alarm.isSendSms);
